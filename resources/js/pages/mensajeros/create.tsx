                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Complete los datos del nuevo mensajero
                        </p>
                    </div>
                </div>

                <form
                    action={mensajeros.store().url}
                    method="post"
...
CreateMensajero.layout = {
    breadcrumbs: [
        { title: 'Mensajeros', href: mensajeros.index().url },
        { title: 'Nuevo', href: mensajeros.create().url },
    ],
};
